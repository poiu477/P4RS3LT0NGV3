...
## Files changed
 ...
 js/core/transformChains.js                         |  48 +-
 js/tools/TransformTool.js                          | 130 ++--
 package.json                                       |   3 +-
 templates/transforms.html                          |  85 +--
 tests/test_transform_apply_mode.js                 | 136 ++++
 tests/test_transform_recipes.js                    |  94 ++-
 14 files changed, 1451 insertions(+), 88 deletions(-)
...
index 2219ea7..5d5828c 100644
--- a/README.md
+++ b/README.md
@@ -260,31 +260,32 @@ Categories match the Transform tab and the folders under `src/transformers/` (ea
...
@@ -118,20 +122,25 @@ class TransformTool extends Tool {
...
@@ -548,35 +557,21 @@ class TransformTool extends Tool {
...
@@ -889,20 +884,30 @@ class TransformTool extends Tool {
...
@@ -1113,124 +1118,156 @@ class TransformTool extends Tool {
             },
...
+                        : `${transform.name}${this.transformIoMode === 'decode' ? ' decoded and copied!' : ' applied and copied!'}`;
                 ...
                 if (inputBox) {
                     this.focusWithoutScroll(inputBox);
@@ -1481,20 +1518,21 @@ class TransformTool extends Tool {
...
@@ -225,21 +289,21 @@ TC.runStagedRecipeAsync(asyncRecipe, 'Hello').then((result) => {
...
+            { kind: 'image', value: 'data:image/png;base64,mocked', text: 'secret' }
         ...
         const emojiCalls = [];
@@ -275,26 +339,52 @@ TC.runStagedRecipeAsync(asyncRecipe, 'Hello').then((result) => {
             };
